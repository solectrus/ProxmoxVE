...
# upstream   https://github.com/solectrus/ProxmoxVE.git (fetch)
# upstream   https://github.com/solectrus/ProxmoxVE.git (push)
```
...
print_info "Upstream: https://github.com/solectrus/ProxmoxVE"
echo ""
